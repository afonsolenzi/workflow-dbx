...
def create_pipeline(self):
    ...
    notebook = "/".join(path.split("/")[:-1]) + "/DWRW 2.2.3L - DLT Job"
...
def get_job_config(self):
    ...
    notebook_1 = "/".join(notebook_1.split("/")[:-1]) + "/DWRW 2.2.2L - Batch Job"
    ...
    notebook_2 = "/".join(notebook_2.split("/")[:-1]) + "/DWRW 2.2.4L - Exploring Results"
...
def validate_job_config(self):
    ...
    assert task_name == "Exploring-Results", f"Expected the third task to have the name \"Query-Results\", found \"{task_name}\""
